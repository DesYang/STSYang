...
<div class="avatar">
	<c:choose>
   			<c:when test="${_LOGIN_USER_.portrait!=null && _LOGIN_USER_.portrait!='' }">
   				<img alt="" src="${_LOGIN_USER_.portrait}" class="img-thumbnail"><br>
   			</c:when>
   			<c:otherwise>
   				<img  src="<%=request.getContextPath() %>/images/default_avatar.png" class="img-thumbnail"><br>
   			</c:otherwise>
   	</c:choose>
	</div>
	<br/>
