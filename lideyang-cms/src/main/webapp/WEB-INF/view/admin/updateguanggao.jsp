      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">广告修改</li>
          </ol>
          	<form action="/admin/updateguanggao" method="post">
          		<input type="hidden" name="id" value="${guanggao.id }">
          		名称:<input type="text" name="name" value="${guanggao.name }"><br>
